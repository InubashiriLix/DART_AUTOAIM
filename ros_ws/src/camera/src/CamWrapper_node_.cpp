...
private:
  ...
  void publish_camera_info() {
    ...
    cv::Mat cameraMatrix = (cv::Mat_<double>(3, 3) << 1557.2, 0.2065, 612 / 2,
                            0, 1557.5, 506.5128 / 2, 0, 0, 1);
    cv::Mat distCoeffs =
        (cv::Mat_<double>(1, 5) << -0.1295, 0.0804, 4.85E-04, 6.37E-04, 0.2375);
    cv::Mat dst = cv::getOptimalNewCameraMatrix(
        cameraMatrix, distCoeffs, cv::Size(img_width, img_height), 0);
